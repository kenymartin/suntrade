...
export class UserService implements IReadable<User>, IFilter<User> {
  ...
  applyFilter(options: any): Promise< (GetResult< { id: number; contactId: number; username: string; email: string; password: string; isActive: boolean; createdAt: Date; createdBy: number; updatedAt: Date; updatedBy: number; isDeleted: boolean; scalars: any; objects: any; composites: any; }, any > & {})[] > { try {
  ...
  getByEmail(email: string): Promise< GetResult< { id: number; contactId: number; username: string; email: string; password: string; isActive: boolean; createdAt: Date; createdBy: number; updatedAt: Date; updatedBy: number; isDeleted: boolean; scalars: any; objects: any; composites: any; }, any > & {} > {
    try {
      this.result = prisma.user.findUnique({
        where: { email: email },
        select: {
