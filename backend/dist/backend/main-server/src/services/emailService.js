...
var EmailService = /** @class */ (function (_super) {
    ...
    EmailService.prototype.getById = function (id) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.prisma.email.findUnique({ where: { id: id } })];
                    case 1:
                        _a.result = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.prisma.email.findMany()];
                    case 1:
                        _a.result = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    EmailService.prototype.update = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.prisma.email.update({
                                where: { id: data.id },
                                data: data,
                            })];
                    case 1:
    ...
    EmailService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.prisma.email.create({ data: data })];
                    case 1:
                        _a.result = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.prisma.email.delete({ where: { id: id } })];
                    case 1:
                        _a.result = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
